...
TEST(BTreeIndexSimpleDebug, FirstInsert) {
    ...
    std::cout << "  Offset 4 (PageType): " << std::hex << (int)(unsigned char)data[4] << std::dec
              << std::endl;
    std::cout << "  Offset 16 (BTreePageType): " << std::hex << (int)(unsigned char)data[16]
              << std::dec << std::endl;
